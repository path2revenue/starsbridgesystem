    ...
    return (
        <section id="rdv" className="py-24 px-6">
            ...
            >
                ...
                <div style={{ backgroundColor: '#111827', border: '1px solid #1E293B', borderRadius: 16, padding: 8, overflow: 'visible' }}>
                    <iframe
                    ...
                    <div className="flex flex-wrap gap-x-6 gap-y-3">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-2">
                                <div className="w-5 h-5 rounded-full bg-[#EAB308]/15 border border-[#EAB308]/40 flex items-center justify-center shrink-0">
