...
export default function FinalCTA() {
    return (
        <section className="py-24 px-6 relative overflow-hidden">
            {/* Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-[#3B82F6]/3 rounded-full blur-[180px] pointer-events-none" />
            <div className="absolute top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[200px] bg-[#EAB308]/2 rounded-full blur-[150px] pointer-events-none" />
            ...
            <div className="relative z-10 max-w-[800px] mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
                    <a
                        href="#rdv"
                        className="inline-flex items-center gap-2 px-10 py-5 bg-[#EAB308] text-[#0C111D] font-bold rounded-full text-lg hover:bg-[#FACC15] transition-all duration-300 cursor-pointer"
                    >
                    ...
                    <a
                        ...
                        className="inline-flex items-center gap-2 px-8 py-5 border border-[#334155] text-[#94A3B8] rounded-full text-lg hover:border-[#60A5FA] hover:text-white transition-all duration-300 cursor-pointer"
                    >
