        ...
        <section className="relative flex flex-col items-center justify-center overflow-hidden pt-24 pb-10">
            ...
            <div className="absolute inset-0 z-0">
                <div className="absolute top-[-50%] left-[-50%] w-[200%] h-[200%] animate-[meshMove_20s_ease-in-out_infinite]">
                    <div className="absolute top-[10%] left-[20%] w-[500px] h-[500px] rounded-full bg-[#3B82F6]/3 blur-[180px]" />
                    <div className="absolute top-[50%] right-[15%] w-[400px] h-[400px] rounded-full bg-[#2563EB]/2 blur-[150px]" />
                </div>
            </div>
            ...
            <div className="relative z-10 max-w-[1100px] mx-auto px-6 w-full">
                ...
                <div className="text-center mb-6">
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#1E293B] bg-[#111827]/80 text-xs text-[#94A3B8] mb-4 animate-[fadeInUp_0.6s_ease-out]">
                        ...
                        +800K€ de CA généré pour nos clients
                    </div>
                ...
                {/* ===== CENTER: VSL VIDEO ===== */}
                <div className="relative rounded-2xl overflow-hidden mb-10 animate-[fadeInUp_1.1s_ease-out] border border-[#3B82F6]/20">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 animate-[fadeInUp_1.3s_ease-out]">
                    <a
                        href="#rdv"
                        className="group px-8 py-4 bg-[#EAB308] text-[#0C111D] font-bold rounded-full text-lg hover:bg-[#FACC15] transition-all duration-300 cursor-pointer"
                    >
                    ...
                    <a
                        ...
                        className="px-8 py-4 border border-[#334155] text-[#94A3B8] rounded-full text-lg hover:border-[#60A5FA] hover:text-white transition-all duration-300 cursor-pointer"
                    >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-[800px] mx-auto animate-[fadeInUp_1.5s_ease-out]">
                    {[
                        { value: 800, suffix: "K+", label: "CA généré pour nos clients" },
