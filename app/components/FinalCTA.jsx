            ...
            <div className="relative z-10 max-w-[800px] mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
                    ...
                    <a
                        ...
                        className="inline-flex items-center gap-2 px-6 sm:px-8 py-4 sm:py-5 bg-[#25D366] text-white font-semibold rounded-full text-base sm:text-lg hover:bg-[#1ebe5a] transition-all duration-300 cursor-pointer"
                    >
                        ...
                        <span>{config?.finalCTA?.whatsappCta || "📊 Étude de cas : 0 → +20K en 30j"} <span className="text-white/80 text-sm font-normal">(groupe)</span></span>
                    </a>
                </div>
