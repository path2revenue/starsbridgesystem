    ...
    return (
        <section className="relative flex flex-col items-center justify-center overflow-hidden pt-10 pb-10">
            ...
            <div className="relative z-10 max-w-[1100px] mx-auto px-6 w-full">
                ...
                {/* ===== CTAs ===== */}
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-12 animate-[fadeInUp_1.3s_ease-out]">
                    <a
                    ...
                    >
                        ...
                        <span>{waCtaText} <span className="text-white/70 font-normal">(Groupe WhatsApp)</span></span>
                    </a>
                </div>
