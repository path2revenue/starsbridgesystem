            ...
            <div className="relative z-10 max-w-[1100px] mx-auto px-6 w-full">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 animate-[fadeInUp_1.3s_ease-out]">
                    ...
                    <a
                        ...
                        className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-[#25D366] text-white font-semibold rounded-full text-base sm:text-lg hover:bg-[#1ebe5a] transition-all duration-300 cursor-pointer"
                    >
                        ...
                        <span>{waCtaText} <span className="text-white/80 text-sm font-normal">(groupe)</span></span>
                    </a>
                </div>
