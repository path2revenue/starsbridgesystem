            ...
            >
                ...
                <div className="mt-10 grid md:grid-cols-2 gap-6 items-start">
                    ...
                    <div className="flex items-center gap-4 justify-end">
                        <p className="text-sm text-[var(--color-text-secondary)]">{config?.calendar?.whatsappCopy || "Tu veux voir comment on fait ?"}</p>
                        <a
                            href={waLink}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#25D366] text-white rounded-lg font-medium text-sm hover:bg-[#22c55e] transition-colors whitespace-nowrap"
                        >
                            ...
                            <span>{config?.calendar?.whatsappLabel || "📊 Voir l'étude de cas (0 → +20K)"} <span className="text-white/70 font-normal">(Groupe WA)</span></span>
                        </a>
                    </div>
                </div>
            </div>
